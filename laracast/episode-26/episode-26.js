    ...
    return {
        ...
        gameArea: {
            set disabled(value){
                ...
                for(let ii = 0; ii < elements.length; i++){
        ...
        settings: {
            set disabled(value){
                ...
                // Array.prototype.forEach.call(form.elemnts, el => {
                //     el.disabled = value;
                // });
            }
        },
        ...
        getGuess(){
            return Number(inputGuessElement.value);
        },
...
class Game {
    ...
    constructor({minRange = 1, maxRange = 10, maxAttempts = 3, allowDuplicateGuesses = false } = {}) {
        ...
        this.#maxAttempts = parseIn(maxAttempts);
