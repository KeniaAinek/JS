...
<head>
    ...
    <title>JavaScript for PHP Developers - Episode 17</title>
...
<body class="bg-gray-700 dark min-h-screen text-white">
        ...
        <nav class="section md:!px-8 w-full py-3 bg-gray-950 border-b border-b-gray-700 mb-8 shadow-sm">
            <div class="relative h-full items-center">
                <div class="relative h-full flex justify-between">
                    <span class="text-xs font-bold uppercase text-gray-400">Episode 17: Form Basics</span>       
    ...
    <div class="w-full p-6 bg-gray-800">
        ...
        <div class="w-full flex gap-2 justify-center">
            <form id="settings-form">
                <div>
                    <input type="radio" name="game-type-selector" id="game-type-node" value="options-mode">
                    <label for="game-type-mode">Mode</label>
                    <input type="radio" name="game-type-selector" id="game-type-custom" value="options-custom">
                    <label for="game-type-selector">Custom</label>
                </div>

                <div id="options-customs" class="hidden">
                ...
                <div class="inline" id="options-mode">
                    <select name="game-level" id="game-level" class="border p-2 w-40 bg-gray-900">
                    <option data-min-range="1" data-max-range="10" data-attemps="10" value="easy">Easy</option>
                    <option data-min-range="1" data-max-range="20" data-attemps="7" value="medium">Medium</option>
                    <option data-min-range="1" data-max-range="100" data-attemps="5" value="hard">Hard</option>
                </select>
                </div>
    ...
    <script src="episode-17.js"></script>
</body>
</html>