...
easyGame.secretNumber = 5;
// easyGame.checkGuess(7);

const standAloneFunction = easyGame.checkGuess;

const standAloneObject = {
    secretNumber: 7
};

standAloneObject.checkGuess = easyGame.checkGuess;


const easyGameGameCheckGuess = easyGame.checkGuess.bind(easyGame);

easyGameGameCheckGuess(5);